...
export const LegalStudiesIntroVideoGate = () => {
  ...
  return createPortal(
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="legal-studies-intro-video-title"
      onKeyDown={(event) => {
        if (event.key === 'Tab') event.preventDefault();
      }}
    >
      <h2 id="legal-studies-intro-video-title" className="sr-only">Legal Studies introduction</h2>
      <video
        className="h-full w-full object-cover"
        src="/legal_intro_video.mp4"
        autoPlay
        muted
        playsInline
        onEnded={dismiss}
