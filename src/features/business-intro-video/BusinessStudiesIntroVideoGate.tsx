...
export const BusinessStudiesIntroVideoGate = () => {
  ...
  return createPortal(
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="business-studies-intro-video-title"
      onKeyDown={(event) => {
        if (event.key === 'Tab') event.preventDefault();
      }}
    >
      <h2 id="business-studies-intro-video-title" className="sr-only">Business Studies introduction</h2>
      <video
        className="h-full w-full object-cover"
        src="/business_intro_video.mp4"
        autoPlay
        muted
        playsInline
        onEnded={dismiss}
