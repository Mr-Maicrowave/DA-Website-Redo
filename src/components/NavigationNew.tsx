...
const NavigationNew = ({ heroMode: _heroMode = false }: NavigationNewProps) => {
  ...
  return (
    <>
      ...
      <div
        className="fixed top-0 left-0 right-0 z-[60] hidden min-[1100px]:block"
        data-da-nav-state={navState}
      >
        <nav
          ref={desktopNavRef}
