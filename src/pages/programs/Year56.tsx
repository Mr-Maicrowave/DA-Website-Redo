...
const approachPoints = [
  { icon: '✓', bg: c.goldPale, title: 'Selective school preparation', sub: 'Specific skills for OC, selective, and scholarship exams' },
  { icon: '✓', bg: c.goldPale, title: 'NAPLAN Year 5 aligned', sub: 'We target tested domains throughout the year' },
  { icon: '✓', bg: c.goldPale, title: 'Small groups (3–4 students)', sub: 'Senior students get individual coaching, not a lecture' },
  { icon: '✓', bg: c.goldPale, title: 'High school transition support', sub: 'Building the study habits that Year 7 demands' },
...
const badgeColors: Record<string, { bg: string; text: string }> = {
  NAPLAN: { bg: c.goldPale, text: c.navy },
  Core: { bg: c.goldPale, text: c.navy },
...
const Year56 = () => {
  return (
    <div className="min-h-screen overflow-x-hidden pt-[120px]" style={{ background: c.white, color: c.navy, fontFamily: "'Segoe UI', system-ui, sans-serif" }}>
      ...
      {/* Urgency banner */}
      <div style={{ background: `linear-gradient(135deg, ${c.goldPale} 0%, ${c.soft} 100%)`, borderTop: `3px solid ${c.goldLight}`, borderBottom: `3px solid ${c.goldLight}`, padding: '18px 52px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 32, flexWrap: 'wrap' }}>
        {[
      ...
      <div style={{ background: 'linear-gradient(135deg, #F7F4EE 0%, #FFFFFF 55%, rgba(240,203,106,0.12) 100%)', padding: '80px 52px 72px', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', top: -60, right: -60, width: 320, height: 320, borderRadius: '50%', background: 'radial-gradient(circle, rgba(212,175,55,0.2), transparent 65%)', pointerEvents: 'none' }} />
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1.5fr 1fr', gap: 36, maxWidth: 1100, margin: '0 auto', alignItems: 'start' }} className="y56-grid-responsive">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
            ...
            <div style={{ background: c.white, border: `2px solid ${c.border}`, borderTop: `4px solid ${c.gold}`, borderRadius: 20, padding: '28px 26px', boxShadow: '0 4px 16px rgba(10,27,52,0.07)' }}>
              <div style={{ fontSize: '0.72rem', fontWeight: 800, letterSpacing: '2px', textTransform: 'uppercase', color: c.gold, marginBottom: 6 }}>High School Readiness Checklist</div>
            ...
            <div style={{ background: c.white, border: `2px solid ${c.border}`, borderTop: `4px solid ${c.gold}`, borderRadius: 20, padding: '28px 26px', boxShadow: '0 4px 16px rgba(10,27,52,0.07)' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                <div style={{ width: 44, height: 44, borderRadius: '50%', background: c.goldPale, border: `2.5px solid ${c.goldLight}`, display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 900, color: c.navy, fontSize: '1rem' }}>P</div>
                <div>
