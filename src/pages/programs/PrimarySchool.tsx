  ...
  return (
    <section ref={heroRef} className="ps-hero" aria-labelledby="primary-title">
      ...
      <motion.div className="ps-hero__content">
        ...
        <motion.div {...entrance(0.27, 12)} className="ps-hero__title-rule" aria-hidden="true" />
...
const PrimarySchool = () => (
  <div className="primary-story">
    ...
    <style>{`
      ...
      .ps-hero__content{position:absolute;z-index:8;top:clamp(8rem,19svh,12rem);left:clamp(3rem,5.25vw,6.5rem);width:min(42rem,46vw);margin:0;padding:0;color:#09223d;text-align:left;text-shadow:0 1px 0 rgba(255,255,255,.32)}
      .ps-hero .ps-kicker{display:flex;align-items:center;justify-content:flex-start;gap:.8rem;margin:0 0 1.7rem;color:#173d5c;font-size:.7rem;font-weight:800;letter-spacing:.22em;text-transform:uppercase}
      .ps-hero .ps-kicker:before{width:2.6rem;height:1px;background:#b47d20;content:""}
      .ps-hero h1{max-width:none;margin:0;color:#09223d;font-family:"Cormorant Garamond",Georgia,serif;font-size:clamp(3.6rem,4.45vw,4.8rem);font-weight:500;letter-spacing:-.04em;line-height:.94;text-wrap:balance}
      .ps-hero__title-rule{width:3.25rem;height:2px;margin:1.55rem 0 1.8rem;background:#b47d20}
      .ps-hero__intro{max-width:24rem;margin:0;color:#173d5c;font-family:"DM Sans",Arial,sans-serif;font-size:clamp(.98rem,1.08vw,1.12rem);font-style:normal;line-height:1.55;text-wrap:pretty}
