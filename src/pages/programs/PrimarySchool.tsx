    ...
    <section ref={sectionRef} id="foundation" className="ps-foundation-intro" aria-labelledby="foundation-title">
      ...
      <div className="ps-foundation-story">
        ...
        <div className="ps-foundation-curriculum">
          ...
          <motion.div className="ps-foundation-curriculum__panel" {...reveal(0.12)}>
            <h3>Years 1–2 curriculum</h3>
            <p>Our teaching is aligned to the NSW Curriculum and adapted to the student’s current level.</p>
            <ul>
              <li><Check />Phonics, decoding and reading fluency</li>
              <li><Check />Sentence construction, handwriting and vocabulary</li>
              <li><Check />Number sense, place value and mathematical reasoning</li>
            </ul>
          </motion.div>
        </div>
      </div>
