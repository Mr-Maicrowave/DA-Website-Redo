...
/* ── Scroll-reveal wrapper: each manuscript page gently rises into view ── */
...
const PrincipalReflectionsManuscript = () => {
  return (
    <>
      <SEO
        ...
        canonicalUrl="/principal-reflections-manuscript"
      />
      <NavigationNew />
...
export default PrincipalReflectionsManuscript;
