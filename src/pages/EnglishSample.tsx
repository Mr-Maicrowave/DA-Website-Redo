/**
 * EnglishSample.tsx — /english-sample page
 * Restored from commit c47221c ("Route book homepage to English sample"),
 * matching the reference build at da-website-updated-ixfropdsv-da-tuition-portal.vercel.app.
 *
 * IMPORTANT: this page was previously accidentally overwritten with the
 * homepage (Index) content during unrelated homepage edits. Do NOT repoint
 * the "/english-sample" route to Index, and do NOT edit this file as a
 * side effect of homepage changes — only touch it when English Sample
